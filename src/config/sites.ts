...
const sites: Record<string, SiteConfig> = {
  ...
  ijolg: {
    slug: 'ijolg',
    domain: 'ijolg.com',
    name: 'International Journal of Law & Governance',
    shortName: 'IJOLG',
    description: 'Law and Governance Research Publication',
    dbEnvVar: 'DATABASE_URL_IJOLG',
    smtpUserEnvVar: 'SMTP_USER_IJOLG',
    smtpPassEnvVar: 'SMTP_PASS_IJOLG',
    smtpFromEnvVar: 'SMTP_FROM_IJOLG',
    r2BucketEnvVar: 'R2_BUCKET_IJOLG',
    r2PublicUrlEnvVar: 'R2_PUBLIC_URL_IJOLG',
    nextauthSecretEnvVar: 'NEXTAUTH_SECRET_IJOLG',
  },
  ijstar: {
    slug: 'ijstar',
    domain: 'ijstar.com',
    name: 'International Journal of Social Thought and Research',
    shortName: 'IJSTAR',
    description: 'Social Sciences and Research Publication',
    dbEnvVar: 'DATABASE_URL_IJSTAR',
    smtpUserEnvVar: 'SMTP_USER_IJSTAR',
    smtpPassEnvVar: 'SMTP_PASS_IJSTAR',
    smtpFromEnvVar: 'SMTP_FROM_IJSTAR',
    r2BucketEnvVar: 'R2_BUCKET_IJSTAR',
    r2PublicUrlEnvVar: 'R2_PUBLIC_URL_IJSTAR',
    nextauthSecretEnvVar: 'NEXTAUTH_SECRET_IJSTAR',
  },
  ejoas: {
    slug: 'ejoas',
    domain: 'ejoas.com',
