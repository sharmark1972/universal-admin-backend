  ...
  persist(
    ...
    }),
    {
      ...
      partialize: (state) => ({
        ...
        // Don't persist papersData - always fetch fresh
        papersData: undefined,
        papersLoaded: false,
        issues: state.issues,
        issuesLoaded: state.issuesLoaded,
        conferencesData: state.conferencesData,
        conferencesLoaded: state.conferencesLoaded,
        ebooksData: state.ebooksData,
        ebooksLoaded: state.ebooksLoaded,
        certificates: state.certificates,
        certificatesLoaded: state.certificatesLoaded,
        journals: state.journals,
        journalsLoaded: state.journalsLoaded,
        teamMembers: state.teamMembers,
        teamMembersLoaded: state.teamMembersLoaded,
        editorialMembers: state.editorialMembers,
        editorialLoaded: state.editorialLoaded,
        archives: state.archives,
        archivesLoaded: state.archivesLoaded,
        analyticsData: state.analyticsData,
        analyticsLoaded: state.analyticsLoaded,
        analyticsRange: state.analyticsRange,
        settings: state.settings,
        settingsLoaded: state.settingsLoaded,
        advisoryMembers: state.advisoryMembers,
        advisoryLoaded: state.advisoryLoaded,
        reviewerMembers: state.reviewerMembers,
        reviewerLoaded: state.reviewerLoaded,
        fees: state.fees,
        feesLoaded: state.feesLoaded,
      }),
    }
  )
);
